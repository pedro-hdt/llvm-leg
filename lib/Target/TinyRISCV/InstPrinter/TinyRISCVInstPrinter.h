//== TinyRISCVInstPrinter.h - Convert LEG MCInst to assembly syntax -*- C++ -*-=//
//
...
///
/// \file
/// \brief This file contains the declaration of the TinyRISCVInstPrinter class,
/// which is used to print TinyRISCV MCInst to a .s file.
///
//===----------------------------------------------------------------------===//

#ifndef TinyRISCVINSTPRINTER_H
#define TinyRISCVINSTPRINTER_H
