//===-- TinyRISCVInstrInfo.h - TinyRISCV Instruction Information --------*- C++ -*-===//
//
...
#ifndef TinyRISCVINSTRUCTIONINFO_H
#define TinyRISCVINSTRUCTIONINFO_H
...
class TinyRISCVInstrInfo : public TinyRISCVGenInstrInfo {
  const TinyRISCVRegisterInfo RI;
  virtual void anchor();
...
public:
  ...
  ///
  const TinyRISCVRegisterInfo &getRegisterInfo() const { return RI; }
